...
app.post('/decrypt', function(req, res) {
	...
	res.send(decrypt(req.body.cipher, req.body.key) + "\n");
});

var server = app.listen(55741, function () {
...
// document.write(decrypt(unescCtrlCh("!92![¦!11!Zª58;5­¨!33!sù·½ì!39!ìeÒ«!10!"),"Iate1milrve%ster"));
// document.write(">");
// document.write(decrypt(unescCtrlCh("!92![¦!11!Zª58;5­¨!33!sù·½ì!39!ìeÒ«!10!"),"Iate1milrve%ster"));
// document.write("</a>");
// -->
